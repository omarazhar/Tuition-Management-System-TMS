...
public class DashboardAdapter extends ArrayAdapter<Date> {

    List<Date> cellDates;
    LayoutInflater inflater;
    List<Integer> DaysToTeach;

    public DashboardAdapter(@NonNull Context context, List<Date> cellDates) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView singleCell = convertView.findViewById(R.id.single_cell_text);
